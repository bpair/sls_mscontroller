...
const MSGATT = {
    ...
    TOPIC: 'tpc', //Topic of original Message
...
exports.enrichInboundEvent = exports.enrichInboundEvent;
...
exports.parsePayloads = exports.parsePayloads;
...
function parseRawPayloads(event) {
    ...
    if (!_.isNil(event[MSGATT.RAW])) {
        lines = event[MSGATT.RAW].split(os.EOL);
...
exports.parseRawPayloads = exports.parseRawPayloads;
...
function validateGenericEvent(event) {
    ...
    logger.debug('Parsed message %j', event);

    return event;
}
exports.validateGenericEvent = exports.validateGenericEvent;
...
function handleEvent(event) {
    ...
    switch (event[MSGATT.CMD]) {
        case CMD.PRESENTATION:
        ...
        case CMD.STREAM:
            ...
            break;
        default:
            logger.error('Command Not Recognized %j', event);
            break;
    }
    return event;
}
exports.handleEvent = exports.handleEvent;
...
exports.handlePresentationEvent = exports.handlePresentationEvent;
...
function handleSetEvent(event) {
    ...
    return dbUtils.lookupIntegrationByKey(event, false, TBLPRE)
        ...
        .then(function (data) {
            ...
            return postHTTPMsg(event.topic + '/' + TOPIC_TELEMETRY, event, 1);
        });
}
exports.handleSetEvent = exports.handleSetEvent;
...
exports.handleRequestEvent = exports.handleRequestEvent;
...
function handleInternalEvent(event) {
    ...
    switch (event[MSGATT.TYP]) {
        case INTERNALTYP.I_BATTERY_LEVEL:
            handleBatteryLevelEvent(event);
            break;
        case INTERNALTYP.I_CONFIG:
            handleConfigEvent(event);
            break;
        case INTERNALTYP.I_ID_REQUEST:
            handleNodeIdRequestEvent(event);
            break;
        case INTERNALTYP.I_SKETCH_NAME:
            handleSketchNameEvent(event);
            break;
        case INTERNALTYP.I_SKETCH_VERSION:
            handleSketchVersionEvent(event);
            break;
        case INTERNALTYP.I_TIME:
            handleTimeRequestEvent(event);
            break;
        default:
            logger.error('Command Not Recognized %j', event);
            break;
...
exports.handleInternalEvent = exports.handleInternalEvent;
...
exports.handleSketchNameEvent = exports.handleSketchNameEvent;
...
exports.handleSketchVersionEvent = exports.handleSketchVersionEvent;
