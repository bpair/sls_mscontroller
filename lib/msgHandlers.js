...
function handleInboundEvent(event, context) {
    ...
    event = msgUtils.validateGenericEvent(event);
    ...
    Promise.all(events.map(function (element) {
            return Promise.resolve()
                .then(function (data) {
                    return msgUtils.validateParsedEvent(element);
                })
                .then(function (data) {
        ...
        .catch(function (data) {
            logger.error('Error caught handling inbound messages');
